...
const qualityWarnings = workspace.validateChartQuality({ chartModel: { nodes: [{ id: 'a', label: 'A', x: 20, y: 20 }, { id: 'b', label: 'B', x: 180, y: 180 }, { id: 'c', label: 'C', x: 180, y: 20 }, { id: 'd', label: 'D', x: 20, y: 180 }, { id: 'orphan', label: '孤立' }], edges: [{ source: 'a', target: 'b' }, { source: 'c', target: 'd' }] } }, '<svg viewBox="0 0 300 240"></svg>');
assert.ok(qualityWarnings.warnings.some(warning => /孤立节点：孤立/.test(warning)));
