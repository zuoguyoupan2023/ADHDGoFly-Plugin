...
assert.match(workflow, /确定性布局/); assert.match(workflow, /CI/); assert.match(workflow, /#0f172a/); assert.match(workflow, /#e11d48/);
...
assert.match(lifecycle, /agf-chart-node/); assert.match(lifecycle, /状态/);
