...
['jixia.tabs.chat', 'jixia.tabs.quiz', 'jixia.tabs.explain', 'jixia.tabs.vocab', 'jixia.chart.title', 'jixia.ui.newConversation', 'jixia.ui.clearWorkspace', 'jixia.ui.processingAnalysis', 'jixia.ui.quizGenerating', 'jixia.ui.claimFact', 'jixia.ui.confidence'].forEach(key => assert.ok(zhKeys.has(key) && enKeys.has(key), `缺少关键 i18n key: ${key}`));
